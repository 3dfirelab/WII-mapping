...
################################
    ...
    outgdf[~outgdf['WIIoverIndus'].isnull()].plot(ax=ax,cax=cax,column='WIIoverIndus',legend=True,vmax=np.percentile(outgdf[~outgdf['WIIoverIndus'].isnull()]['WIIoverIndus'],95),zorder=2)
    ax.set_xlim(xminAll,xmaxAll)
    ax.set_ylim(yminAll,ymaxAll)
    #set axis
    bbox = shapely.geometry.box(xminAll, yminAll, xmaxAll, ymaxAll)
    ...
    ax.set_title('Ratio WII Area over Industrial Area per Province/State', pad=30)
    ...
    outgdf[~outgdf['WIIoverFuel'].isnull()].plot(ax=ax,cax=cax,column='WIIoverFuel',legend=True,vmax=np.percentile(outgdf[~outgdf['WIIoverFuel'].isnull()]['WIIoverFuel'],95),zorder=2)
    ax.set_xlim(xminAll,xmaxAll)
    ax.set_ylim(yminAll,ymaxAll)
    #set axis
    bbox = shapely.geometry.box(xminAll, yminAll, xmaxAll, ymaxAll)
    ...
    ax.set_title('Ratio WII Area over total Fuel Area per Province/State', pad=30)
